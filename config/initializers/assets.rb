...
base_js    = %w( site/site.js blenbox/blenbox.js oxys/oxys.js )
vendor_js  = %w( dragdealer.js jquery-1.9.1.js shortcut.js )
base_css   = %w( site/styles-dark.css blenbox/blenbox.css oxys/oxys.css oxys/header.css oxys/mainmenu-geral.css oxys/mainmenu-covers.css )
